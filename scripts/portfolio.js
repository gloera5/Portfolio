        ...
        canvasID.addEventListener("mousedown", function(e) {
            ...
            if(selectedBody != null){
                ...
                if(selectedBody.BoxNumber == 1001){
                    ...
                    console.log('Vimeo');
                    window.open('http://vimeo.com/socket', '_blank');
                }
                else if(selectedBody.BoxNumber == 1002){

                    console.log('OnSite');
                    window.open('http://onsite.io', '_blank');
                }
                else if(selectedBody.BoxNumber == 1003){

                    console.log('OnSite');
                    window.open('http://behance.net/socket', '_blank');
                }
                else if(selectedBody.BoxNumber == 1004){

                    console.log('Dribbble');
                    window.open('http://dribbble.com/socket', '_blank');
                }
                else if(selectedBody.BoxNumber == 1005){

                    console.log('Twitter');
                    window.open('http://twitter.com/socketstudios', '_blank');
                }
                else if(selectedBody.BoxNumber == 1006){

                    console.log('Nylllon');
                    window.open('http://nylllon.com', '_blank');
                }
                else if(selectedBody.BoxNumber == 1007){

                    console.log('Socket Studios');
                    window.open('http://socketstudios.com', '_blank');
                }
                else if(selectedBody.BoxNumber == 1008){

                    console.log('Tumblr');
                    window.open('http://socketstudios.tumblr.com', '_blank');
                }
                else if(selectedBody.BoxNumber == 1009){

                    console.log('Linkedin');
                    window.open('http://linkedin.com/in/macgregorpaul', '_blank');
                }
                else if(selectedBody.BoxNumber == 1010){

                    console.log('Pinterest');
                    window.open('http://pinterest.com/socketstudios', '_blank');
                    ...
                    console.log('Ello');
                    window.open('http://ello.co/pm', '_blank');
